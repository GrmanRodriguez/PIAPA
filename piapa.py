...
class Rover:
    ...
    turnClockw = 1.97  # Time needed by the robot to make a 360 degree clockwise turn (TUNED)
    turnCounterClockw = 1.95  # Time needed by the robot to make a 360 degree counterclockwise turn (TUNED)
