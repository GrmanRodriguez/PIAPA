...
class MovementManager():
    ...
    turnClockw = 3.15  # Time needed by the robot to make a 360 degree clockwise turn (TUNED)
    turnCounterClockw = 3.25  # Time needed by the robot to make a 360 degree counterclockwise turn (TUNED)
