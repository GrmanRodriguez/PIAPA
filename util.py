...
class MovementManager():
    ...
    turnClockw = 2.46  # Time needed by the robot to make a 360 degree clockwise turn (TUNED)
    turnCounterClockw = 2.41  # Time needed by the robot to make a 360 degree counterclockwise turn (TUNED)
    ...
    def turn(self, ang):
        ...
        print(self.imuangle)
        print(angle)
        if abs(angle - (self.imuangle + ang)) < self.tolerance and abs(angle - (self.imuangle + ang)) > self.tolerance:
